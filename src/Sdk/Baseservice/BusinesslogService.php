...
class BusinesslogService extends BaseBaseservice {
     ...
     */
    public static function setLog(string $trackingKey,array $trackingNo,string $content,int $userId,string $userName,?bool $isIgnoreErr = true,?array $otherData = []): void
    {
