...
class WxPayConfig extends WxPayConfigInterface
{
    ...
    private function getConf($key){
        $value = '';
        if(class_exists(get_class(new \App\AppConst\WeixinInfo()))){
            $reflect = new \ReflectionClass(get_class(new \App\AppConst\WeixinInfo()));
    ...
    {
        $merchantId = $this->getConf('MERCHANT_ID');
        return $merchantId;
    }
    ...
    {
        $payKey = $this->getConf('PAY_KEY');
        return $payKey;
    }
    public function GetAppSecret()
    {
        $merchantId = $this->getConf('SECRET');
        return $merchantId;
    }
